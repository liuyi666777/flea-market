...
const App = {
  ...
  toggleAssistant() {
    ...
    if (panel) panel.classList.toggle('open', this._assistantOpen);
  },
  ...
  assistantReply(question) {
    ...
    const answers = {
      '如何发布商品？': '点击底部中间的 <b>＋</b> 按钮进入发布页面，填写商品标题、价格、描述、分类等信息后点击"立即发布"即可。发布前需要先登录哦~',
      '怎么联系卖家？': '在商品详情页底部点击 <b>"💬 我想要"</b> 按钮就可以和卖家聊天啦！你也可以先收藏商品再慢慢咨询。',
      '如何注册账号？': '点击底部 <b>"我的"</b> → 点击 <b>"邮箱登录/注册"</b>，输入邮箱和密码即可完成注册。建议填写学号方便身份认证。',
      '交易安全吗？': '我们建议：<br>1️⃣ 尽量选择<b>校内当面交易</b><br>2️⃣ 仔细检查商品成色<br>3️⃣ 贵重物品保留交易凭证<br>如有纠纷请及时联系平台客服。',
      '发布有什么规则？': '📋 发布规则：<br>• 商品需真实有效，禁止虚假信息<br>• 禁止发布违禁品、食品、药品等<br>• 商品描述需如实说明成色<br>• 已售商品请及时标记为已售状态',
      '学校地址在哪？': '📍 山西应用科技学院<br>地址：山西省太原市小店区北格镇<br>校内交易建议在图书馆、食堂等人多的地方进行~',
    };
    botMsg.innerHTML = answers[question] || ('收到你的问题："' + question + '"<br>你可以点击下方快捷按钮，或联系平台管理员获取帮助~');
